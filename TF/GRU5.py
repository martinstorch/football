...
from Estimators import GRU5_Model as gru
...
#  print(teamnames)
  ...
  for i in range(train_steps//evaluate_after_steps):
    ...
    if not skip_predictions:
      for prefix in ["ens/", "p1/", "p3/", "p2/", "p5/", "p4/", "p6/", "sp/", "sm/", "smhb/", "ens/"]:
...
#  print({k:len(v) for k,v in test_X.items()})
  ...
  p = pd.read_csv(model_dir+"/rolling_predictions_df.csv")
  ...
  p3 = pd.read_csv(model_dir+"/ens_rolling_predictions_df.csv")
  ...
  print(p4.pivot_table(index=['Season', "Strategy"], values="Pt", aggfunc=np.mean, columns="Prefix", margins=True))
...
if __name__ == "__main__":
  ...
  parser.add_argument(
      "--model_dir",
      type=str,
      #default="C:/tmp/Football/models_gru5_1415", # always use UNIX-style path names!!!
      ...
      #default="C:/tmp/Football/models_gru5_1718",
      #default="C:/tmp/Football/models_1718_new2", # always use UNIX-style path names!!!
      default="C:/tmp/Football/rolling_gru5_1418",
