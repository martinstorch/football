...
from Estimators import Map_Model as themodel
...
def plot_predictions_2(predictions, features, labels, team_onehot_encoder, prefix="sp/", is_prediction=False, dataset = "Test", skip_plotting=False):
  ...
  if prefix!="ens/":
    ...
    strategy_list = ["p1", "p2","p3","p4","p5","p7","sp","sm","p1pt", "p2pt", "p4pt", "sppt", "smpt"]
...
#  print(teamnames)
  ...
  if predict_new:
    ...
    results = [plot_predictions_2(new_predictions, pred_X, pred_y, team_onehot_encoder, prefix, True, skip_plotting=True) 
      ...
      for prefix in ["ens/", "p1/", "p1pt/", "p3/", "p2/", "p2pt/", "p5/", "p4/", "p4pt/", "p6/", "p7/", "sp/", "sppt/", "sm/", "smpt/", "smhb/"]]
  ...
  for i in range(train_steps//evaluate_after_steps):
    ...
    if not skip_predictions:
      ...
      results = [plot_predictions_2(new_prediction, pred_X, pred_y, team_onehot_encoder, prefix, True, skip_plotting=True) 
        for prefix in ["p1/", "p1pt/", "p3/", "p2/", "p2pt/", "p5/", "p4/", "p4pt/", "p6/", "p7/", "sp/", "sppt/", "sm/", "smpt/", "smhb/", "ens/"]]
      results = pd.concat(results)
      ...
      train_predictions = []
      test_predictions = []
      for prefix in ["p1/", "p1pt/", "p3/", "p2/", "p2pt/", "p5/", "p4/", "p4pt/", "p6/", "p7/", "sp/", "sppt/", "sm/", "smpt/", "smhb/"]:
      #for prefix in ["sp/"]:
...
if __name__ == "__main__":
  ...
  parser.add_argument(
      ...
      default="D:/Models/model_map_1718_new", # always use UNIX-style path names!!!
      ...
      #default="D:/Models/rolling_map_1418",
