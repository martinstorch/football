...
from Estimators import GRU6_Model as gru
...
if __name__ == "__main__":
  ...
  parser.add_argument(
      "--model_dir",
      type=str,
      #default="C:/tmp/Football/models_gru6_1415", # always use UNIX-style path names!!!
      ...
      #default="C:/tmp/Football/models_gru6_1718",
      #default="C:/tmp/Football/models_1718_new2", # always use UNIX-style path names!!!
      default="C:/tmp/Football/rolling_gru6_1418",
