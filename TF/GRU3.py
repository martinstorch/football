...
from Estimators import GRU3_Model as gru
...
#      )
  print(
      df[["Team1", "Team2", "act", "pred", "Where", "est1","est2","Pt", "Prefix"]]
#      .sort_values(["est1","est2"], ascending=[True, False])
      .head(80)
      )
  if skip_plotting:
...
#  print(teamnames)
  ...
  for i in range(train_steps//evaluate_after_steps):
    ...
    if not skip_predictions:
      plot_predictions_2(test_prediction, test_X, test_y, team_onehot_encoder, "p1/", dataset = "Test")                             
      plot_predictions_2(train_prediction, train_X, train_y, team_onehot_encoder, "p1/", dataset = "Train")                             
      plot_predictions_2(test_prediction, test_X, test_y, team_onehot_encoder, "p3/", dataset = "Test")                             
      plot_predictions_2(train_prediction, train_X, train_y, team_onehot_encoder, "p3/", dataset = "Train")                             
      plot_predictions_2(test_prediction, test_X, test_y, team_onehot_encoder, "p2/", dataset = "Test")                             
      plot_predictions_2(train_prediction, train_X, train_y, team_onehot_encoder, "p2/", dataset = "Train")                             
      plot_predictions_2(test_prediction, test_X, test_y, team_onehot_encoder, "p5/", dataset = "Test")                             
      plot_predictions_2(train_prediction, train_X, train_y, team_onehot_encoder, "p5/", dataset = "Train")                             
      plot_predictions_2(test_prediction, test_X, test_y, team_onehot_encoder, "p4/", dataset = "Test")                             
      plot_predictions_2(train_prediction, train_X, train_y, team_onehot_encoder, "p4/", dataset = "Train")                             
      plot_predictions_2(test_prediction, test_X, test_y, team_onehot_encoder, "p6/", dataset = "Test")                             
      plot_predictions_2(train_prediction, train_X, train_y, team_onehot_encoder, "p6/", dataset = "Train")                             
      plot_predictions_2(test_prediction, test_X, test_y, team_onehot_encoder, "sp/", dataset = "Test")                             
      plot_predictions_2(train_prediction, train_X, train_y, team_onehot_encoder, "sp/", dataset = "Train")                             
      plot_predictions_2(test_prediction, test_X, test_y, team_onehot_encoder, "sm/", dataset = "Test")                             
      plot_predictions_2(train_prediction, train_X, train_y, team_onehot_encoder, "sm/", dataset = "Train")                             
      plot_predictions_2(test_prediction, test_X, test_y, team_onehot_encoder, "smhb/", dataset = "Test")                             
      plot_predictions_2(train_prediction, train_X, train_y, team_onehot_encoder, "smhb/", dataset = "Train")                             
...
if __name__ == "__main__":
  ...
  parser.add_argument(
      "--model_dir",
      type=str,
      default="C:/tmp/Football/models_gru3_1415", # always use UNIX-style path names!!!
      ...
      #default="C:/tmp/Football/models_gru3_1718",
      #default="C:/tmp/Football/models_1718_new2", # always use UNIX-style path names!!!
      #default="C:/tmp/Football/rolling_gru3_1418_full2",
