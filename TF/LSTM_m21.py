...
#  feature_column_names_fixed = ["Team1", "Team2", "Where", "Season", "Train"]
  ...
  final_score_enum = ["0:3", "1:3", "0:2", "1:2", "0:1", "0:0", "1:1", "1:0", "2:1", "2:0", "3:1", "3:0"]
...
def plot_predictions_2(predictions, features, labels, team_onehot_encoder, prefix="sp/", is_prediction=False):
...
#  print(predictions[0:2])
  ...
  with tf.Session() as sess:
    points_tensor = lstm_m21.calc_points(tensor[:,0],tensor[:,1], tensor[:,2], tensor[:,3], is_home)[0]
...
#      .sort_values(["est1","est2"], ascending=[True, False])
  ...
  t1.columns = ["None", "Tendency", "Diff", "Full"]
...
def train_and_eval(model_dir, model_type, train_steps, train_data, test_data, predict_new):
...
#  print(test_idx)
  ...
  model = lstm_m21.create_estimator(model_dir, label_column_names)
  print(model)
...
#  print(teamnames)
  ...
  if predict_new:
    ...
    plot_predictions_2(new_predictions, pred_X, pred_y, team_onehot_encoder, "sp/", True)                             
    plot_predictions_2(new_predictions, pred_X, pred_y, team_onehot_encoder, "p1/", True)                             
    plot_predictions_2(new_predictions, pred_X, pred_y, team_onehot_encoder, "p2/", True)                             
    plot_predictions_2(new_predictions, pred_X, pred_y, team_onehot_encoder, "p3/", True)                             
    return
  
  with tf.Session() as sess:
    sess = sess # dummy to avoid syntax warning
    plot_softprob(lstm_m21.makeStaticPrediction(train_X, train_y),6,6,"Static Prediction Train Data")
    plot_softprob(lstm_m21.makeStaticPrediction(test_X, test_y),6,6,"Static Prediction Test Data")
  ...
  for i in range(train_steps//100):
    ...
    plot_predictions_2(test_prediction, test_X, test_y, team_onehot_encoder, "p1/")                             
    plot_predictions_2(train_prediction, train_X, train_y, team_onehot_encoder, "p1/")                             
    plot_predictions_2(test_prediction, test_X, test_y, team_onehot_encoder, "p2/")                             
    plot_predictions_2(train_prediction, train_X, train_y, team_onehot_encoder, "p2/")                             
    plot_predictions_2(test_prediction, test_X, test_y, team_onehot_encoder, "p3/")                             
    plot_predictions_2(train_prediction, train_X, train_y, team_onehot_encoder, "p3/")                             
    plot_predictions_2(test_prediction, test_X, test_y, team_onehot_encoder, "p4/")                             
    plot_predictions_2(train_prediction, train_X, train_y, team_onehot_encoder, "p4/")                             
    plot_predictions_2(test_prediction, test_X, test_y, team_onehot_encoder, "sp/")                             
    plot_predictions_2(train_prediction, train_X, train_y, team_onehot_encoder, "sp/")                             
...
if __name__ == "__main__":
  ...
  parser.add_argument(
      "--model_dir",
      type=str,
      #default="C:/tmp/Football/models_1415", # always use UNIX-style path names!!!
      ...
      #default="C:/tmp/Football/models_1718", # always use UNIX-style path names!!!
