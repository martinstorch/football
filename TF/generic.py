...
from Estimators import generic_Model as themodel
...
def train_and_eval(model_dir, train_steps, train_data, test_data, 
                   predict_new, save_steps, skip_download, max_to_keep, evaluate_after_steps, skip_predictions, skip_plotting, target_system):
...
#  pred_idx = [val for sublist in pred_idx for val in sublist]
  ...
  if predict_new:
    new_predictions = model.predict(
      ...
      , hooks=[ tf.train.LoggingTensorHook(["Model/condprob/H2/W/read:0"], at_end=True), PrinterHook()]
    )
...
#  utils.print_tensors_in_checkpoint_file(FLAGS.model_dir, tensor_name="Model/RNN_1/rnn/multi_rnn_cell/cell_0/gru_cell/gates/kernel", target_file_name="rnn_gates_kernel.csv", all_tensor_names=False, all_tensors=False)
  ...
  train_and_eval(FLAGS.model_dir, FLAGS.train_steps,
                 ...
                 FLAGS.evaluate_after_steps, FLAGS.skip_predictions, FLAGS.skip_plotting, FLAGS.target_system)
...
if __name__ == "__main__":
  ...
  parser.add_argument(
      ...
      #default="D:/Models/model_gen_sky_1718",
      #default="D:/Models/model_gen_pistor_1718",
      #default="D:/Models/model_gen_pistor_1819",
      #default="D:/Models/model_gen_pistor_1819_2",
      default="D:/Models/model_gen_sky_1819_2",
      #default="D:/Models/model_gen_tcs_1718",
