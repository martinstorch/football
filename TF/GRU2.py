...
from Estimators import GRU2_Model as gru
...
def plot_softprob(pred, gs, gc, title="", prefix=""):
  ...
  for i in range(7):
    for j in range(7):
      ...
      if i==j:
        p_draw += sp[i*7+j]
  ax[2].axis('equal')
  ax[2].pie([p_win, p_draw, p_loss], labels=["Win", "Draw", "Loss"], colors=["blue", "green", "red"], startangle=90, autopct='%1.1f%%', radius=1.0,
  ...
  ax[2].bar([0,1,2], height=[p_win, p_draw, p_loss], tick_label=["Win", "Draw", "Loss"], color=["blue", "green", "red"])
  plt.show()
...
#  print(teamnames)
  ...
  if predict_new:
    ...
    plot_predictions_2(new_predictions, pred_X, pred_y, team_onehot_encoder, "p4/", True)                             
  ...
  for i in range(train_steps//evaluate_after_steps):
    ...
    if not skip_predictions:
      ...
      plot_predictions_2(test_prediction, test_X, test_y, team_onehot_encoder, "p5/")                             
      plot_predictions_2(train_prediction, train_X, train_y, team_onehot_encoder, "p5/")                             
      ...
      plot_predictions_2(test_prediction, test_X, test_y, team_onehot_encoder, "p6/")                             
      plot_predictions_2(train_prediction, train_X, train_y, team_onehot_encoder, "p6/")                             
...
if __name__ == "__main__":
  ...
  parser.add_argument(
      ...
      #default="C:/tmp/Football/models_1718",
