...
#      for prefix in ["ens/"] + themodel.prefix_list ] #["ens/", "p1/", "p1pt/", "p3/", "p2/", "p2pt/", "p5/", "p4/", "p4pt/", "p6/", "p7/", "sp/", "sppt/", "sm/", "smpt/", "smhb/"]]
    ...
    results = [plot_predictions_2(new_predictions, decode_dict(pred_X), decode_array(pred_y), team_onehot_encoder, prefix, True, skip_plotting=skip_plotting) 
...
#      new_prediction  = decode_dict(new_prediction)
      ...
      #for prefix in ["sp/"]:
        test_predictions.extend ([plot_predictions_2(test_prediction, decode_dict(test_X), decode_array(test_y), team_onehot_encoder, prefix, dataset = "Test", skip_plotting=skip_plotting)])                             
        train_predictions.extend([plot_predictions_2(train_prediction, decode_dict(train_X), decode_array(train_y), team_onehot_encoder, prefix, dataset = "Train", skip_plotting=skip_plotting)])                             
...
if __name__ == "__main__":
  ...
  parser.add_argument(
      ...
      default="D:/Models/model_mb_1617", # always use UNIX-style path names!!!
