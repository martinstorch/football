...
from Estimators import GRU_Model as gru
...
#  print(teamnames)
  ...
  with tf.Session() as sess:
    ...
    staticPrediction = gru.makeStaticPrediction(train_X, train_y)
    plot_softprob(staticPrediction,6,6,"Static Prediction Train Data")
    staticProbs = staticPrediction["p_pred_12"]
    
  model = gru.create_estimator(model_dir, label_column_names, staticProbs, save_steps, max_to_keep)
  print(model)
