...
from Estimators import generic_Model_winloss as themodel
...
def train_and_eval(model_dir, train_steps, train_data, test_data, 
                   predict_new, save_steps, skip_download, max_to_keep, evaluate_after_steps, skip_plotting, target_system, modes):
...
#  utils.print_tensors_in_checkpoint_file(FLAGS.model_dir, tensor_name="Model/RNN_1/rnn/multi_rnn_cell/cell_0/gru_cell/gates/kernel", target_file_name="rnn_gates_kernel.csv", all_tensor_names=False, all_tensors=False)
  ...
  train_and_eval(FLAGS.model_dir, FLAGS.train_steps,
                 ...
                 FLAGS.evaluate_after_steps, FLAGS.skip_plotting, FLAGS.target_system, FLAGS.modes)
...
if __name__ == "__main__":
  ...
  parser.add_argument(
      "--model_dir",
      type=str,
      #default="D:/Models/model_gen2_pistor_1819",
      default="D:/Models/model_gen2_sky_1819",
